    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-around'}}>
                    <Shoes img={require('../../assets/3.png')} cost="R$140,90" onClick={() => alert('clicou')}>
                        Nike Air MAx Dia
                    </Shoes>
                    <Shoes img={require('../../assets/4.png')} cost="R$280,00" onClick={() => alert('clicou')}>
                        Nike Downshifter 10
                    </Shoes>
                </View>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-around'}}>
                    ...
                    <Shoes img={require('../../assets/6.png')} cost="R$280,00" onClick={() => alert('clicou')}>
                        Nike Downshifter 10
                    </Shoes>
                </View>
            </ScrollView>
